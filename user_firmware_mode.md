...
to 25 to receive more precise X data. The 14-bit range from the left edge to the right edge is 0 to 4265 for a LinnStrument 200, or 0 to 2736 for a LinnStrument 128. The ordering of the messages is LSB, MSB.
